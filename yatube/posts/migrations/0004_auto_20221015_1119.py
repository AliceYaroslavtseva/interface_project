# Generated by Django 2.2.16 on 2022-10-15 07:19
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='group',
            name='title',
            field=models.CharField(help_text='Придумайте название группы', max_length=200, verbose_name='Заголовок группы'),
        ),
        migrations.AlterField(
            model_name='post',
            name='author',
        ...
        migrations.AlterField(
            model_name='post',
            name='text',
            field=models.TextField(help_text='Расскажите о чём-то интересном', verbose_name='Текст поста'),
        ),
    ]
